...
A modern web application designed to streamline the discovery, management, and organization of campus events and student clubs. Built as an intuitive solution for college campuses, it provides a centralized platform for students to explore activities and for organizers to manage them efficiently.

## ✨ Features
- **Role-Based Access:** Distinct portals for **Students** (attendees) and **Organizers** (event managers/clubs).
